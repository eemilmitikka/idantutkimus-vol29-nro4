...
ggplot(rf_rr_prc_df) +
  ...
  scale_x_date(date_breaks = "1 month", date_labels = "%B") +
  # geom_vline(xintercept = dmy("03-03-2022"), linetype = 2, size = 2) +
  # annotate("text", y = 102, x = dmy("22-03-2022"), label = "Valeuutislaki astuu voimaan", size = 6) +
...
ggplot(rf_rr_n_df) +
  ...
  labs(title = "Yhteydenottojen määrä suhteessa vastauksiin",
       ...
       fill = "KYSELYN TULOS") +
  scale_fill_manual(values = c(punainen, harmaa, vihrea),
                    labels = c("Kieltäytyi", "Keskeytetti", "Vastasi loppuun asti")) +
...
"VASTAUSKATO HYÖKKÄYSSOTAAN LIITTYVISSÄ KYSELYISSÄ"
