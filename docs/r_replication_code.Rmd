---
title: "\"Ketkä kannattavat hyökkäyssotaa Venäjällä?\" -artikkelin R-koodit"
author: "Eemil Mitikka"
date: "Päivitetty: 22 marraskuuta 2022"
...
p +
  labs(title = paste(expression("*R*"^2), "Jee")) +
  theme(plot.title = element_markdown())

p +
  labs(title = paste(expression(R^2), "=", chronicles_model_3_coxsnell)) +
  theme(plot.title = element_markdown())

p +
  labs(title = paste(expression(R^2), "=", chronicles_model_3_coxsnell,
                     expression(R^2), "=", chronicles_model_3_nagelkerke))

p +
  theme_oma3() +
  labs(caption = paste(expression(R^2), "=", chronicles_model_3_coxsnell, "\n",
                     expression(R^2), "=", chronicles_model_3_nagelkerke)) +
  theme(plot.caption = element_markdown())

p +
  theme_oma3() +
  labs(caption = paste(chronicles_coxsnell, chronicles_nagelkerke, p_arvot)) +
  theme(plot.caption = element_markdown())
...
chronicles_coxsnell <- paste(expression(R^2), "=", chronicles_model_3_coxsnell,"\n")
chronicles_nagelkerke <- paste(expression(R^2), "=", chronicles_model_3_nagelkerke)

p1 <- 
kuva_4.3 +
  theme_oma3() +
  labs(title = paste("Chronicles-aineiston malli:", odds),
       caption = paste(chronicles_coxsnell, chronicles_nagelkerke, p_arvot)) +
  theme(plot.title = element_text(color = vari_chronicles,
                                  margin = margin(10,0,0,0)),
...
jpeg(here("img/kuva_4_testi.jpg"), units = "in", width = 14, height = 12, res = 300)
p1
dev.off()
...
rf_coxsnell <- paste(expression(R^2), "=", rf_model_2_coxsnell,"<br>")
rf_nagelkerke <- paste(expression(R^2), "=", rf_model_2_nagelkerke,"<br>")
...
# jpeg(here("img/kuva_6.jpg"), units = "in", width = 16, height = 18, res = 300)
# kuva_6
# dev.off()

vtsiom_coxsnell <- paste(expression(R^2), "=", vtsiom_model_2_coxsnell,"<br>")
vtsiom_nagelkerke <- paste(expression(R^2), "=", vtsiom_model_2_nagelkerke,"<br>")
